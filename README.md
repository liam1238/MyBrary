# My Brary 
In this project, iv'e build my own library. There is an options to add new authors, edit authors or delete them, as well as adding new book (by existing authors), edit or delete them.
The user has the option to also serach for authors or books.
